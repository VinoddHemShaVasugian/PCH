...
public class PrizesPage extends IWEBasePage {
	...
	public void createOrEditPrize(String cashPrizeName, String code, String prizeType, String prizeValue,
			String totalNumberOfPrize, String monetaryGiveawayName) {
	...
	public void createPrize(String cashPrizeName, String code, String prizeType, String prizeValue,
			String totalNumberOfPrize, String monetaryGiveawayName) {
	 ...
	 */
	public void saveCashPrize(String cashPrizeName, String code, String prizeType, String prizeValue,
			String totalNumberOfPrize, String monetaryGiveawayName) {
