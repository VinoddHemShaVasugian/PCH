...
public interface BrowserDriver extends SearchContext {
	 ...
	 * windows of this WebDriver instance by passing them to {@link #switchTo()}
	 * .{@link Options#window()}
	 * 
	...
	/**
	 * Use this method when waiting for page load to complete. It will wait
	 * indefinitely till document.readyState is not COMPLETE
	 */
	...
	HtmlElement waitForElementToBeVisible(WebElement ele, int timeUnit);
