...
public class TestWiseHTMLReport {
	...
	Logger reportLog = Logger.getLogger("IWE");
	...
	protected void createTestReportHTML(String testName, boolean exceptionFlag) {
		...
		test_print_out.println("<th width=\"44%\"><strong>" + "Description" + "</strong></td>");
		if (!exceptionFlag) {
			test_print_out.println("<th width=\"8%\"><strong>" + "Result" + "</strong></td>");
		}
				...
				while (it.hasNext()) {
					...
					try {
						...
						test_print_out.println("<td class=\"results\"><a  href=\"./" + testScreenshotPath
								+ "/" + testName + "_" + testData
								+ ".png\" target=\"_blank\"><img class=\"screenshot\" src="
	...
	protected void appendingTestMethodsResult(int method_count_of_class, ITestNGMethod methodName,
		...
		test_print_out.println("<td>" + testResult.getName() + "</td><td>" + methodName.getDescription() + "</td>");
		if (result.equalsIgnoreCase("PASS")) {
			...
			test_print_out.println("<td class=\"results\"><img id=\"skip\" class=\"skip\" src="
					+ "></td>");
			test_print_out.println("<td class=\"results\"><a href=\"./" + testScreenshotPath
					+ "/" + testResult.getName()
					+ ".png\" target=\"_blank\"><img class=\"screenshot\" src="
