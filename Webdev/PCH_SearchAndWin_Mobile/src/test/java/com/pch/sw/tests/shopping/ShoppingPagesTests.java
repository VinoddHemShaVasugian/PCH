...
public class ShoppingPagesTests extends BaseTest {
	...
	@Test(groups={GroupNames.Regression,GroupNames.Mobile,GroupNames.Desktop},
			description = "Guest User - Validate Shopping Carousel on SERP.")
	...
	@Test(groups={GroupNames.Regression,GroupNames.Mobile,GroupNames.Desktop},
			description = "Registered User - Validate Shopping Carousel on SERP.")
	...
	@Test(groups={GroupNames.Regression,GroupNames.Mobile,GroupNames.Desktop},description = "Guest User - Validate Shopping Results page.")
	public void testShoppingResultsPage_GuestUser() {

		homePage.load();
		headerPage.search(searchKeyword, false);

		// Navigate to shopping results page and validate the shopping results page
	...
	@Test(groups={GroupNames.Regression,GroupNames.Mobile,GroupNames.Desktop},description = "Registered User - Validate Shopping Results page.")
	...
	@Test(groups={GroupNames.Regression,GroupNames.Mobile,GroupNames.Desktop},description = "Guest User - Validate Shopping/Product details page.")
	...
	@Test(groups={GroupNames.Regression,GroupNames.Mobile,GroupNames.Desktop},description = "Registered User - Validate Shopping/Product details page.")
