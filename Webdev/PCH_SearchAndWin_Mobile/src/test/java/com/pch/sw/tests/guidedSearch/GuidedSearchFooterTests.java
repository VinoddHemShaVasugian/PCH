...
public class GuidedSearchFooterTests extends BaseTest {
	...
	@Test(groups={GroupNames.Mobile}, description = "Validating Footer part for unrec users - 30028")
	...
	@Test(groups={GroupNames.Mobile}, description = "Validating Footer part for rec users - 30028")
