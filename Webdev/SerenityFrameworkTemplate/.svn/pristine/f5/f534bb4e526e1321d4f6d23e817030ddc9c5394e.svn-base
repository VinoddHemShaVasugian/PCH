 ...
 */
package com.pch.sample.utilities;
...
public class RandomGenerator {
	...
	public static String getName() {
		return firstCharUppercase((org.apache.commons.lang3.RandomStringUtils.randomAlphabetic(10)).replaceAll("f", "z").replaceAll("F", "Z"));
	...
	public static String getName(int length) {
		return firstCharUppercase((org.apache.commons.lang3.RandomStringUtils.randomAlphabetic(length)).replaceAll("f", "z").replaceAll("F", "Z"));
