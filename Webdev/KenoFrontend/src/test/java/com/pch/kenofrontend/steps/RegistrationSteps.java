...
public class RegistrationSteps extends PageObject{
	...
	public void createUserWithPasswordUsingRegFoundation(){
		registrationPage.createUserWithPasswordUsingRegFoundation();
	}
	
	@Step
	public void createuserWithoutPasswordUsingRegFoundation(){
		registrationPage.createUserWithoutPasswordUsingRegFoundation();
	}
}
