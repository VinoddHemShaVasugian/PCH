Narrative:
In order to verify External Ad market tiles
As a Tester
...
Scenario: Verify Ad Market place search activity
GivenStories: stories/sw/jm/SearchAdmin.story#{id:EnablePCHAdMarketPlace}
...
And Verify the daily search count as '1' and 'adm_tileclick_tracking' property contains the ad tile id
...
Scenario: Verify search activity log table for the Ad Market place search activity
...
Then Redirect the user to 'search7' page
And Do a search by click on ad market place tiles and Verify SERP page
And Verify the ad market place search activity details in the search activity log table