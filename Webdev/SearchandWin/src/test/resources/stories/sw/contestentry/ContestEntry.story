...
Then Verify contest entry 'Contest Keys / Search / Registration','Contest Key' for organic user
And Verify contest entry 'Contest Keys / Search / FirstSearch','Contest Key' for organic user
...
And Verify contest entry 'Contest Keys / Search / Registration','Contest Key'
...
Given Register a user with the Optins
When Do a search and Verify SERP page
Then User redirect to the Search application 'ck=BZ999'
And Do a search and Verify SERP page
And User redirect to the Search application 'ck=PP123'
And Do a search and Verify SERP page
...
GivenStories: stories/sw/jm/SearchAdmin.story#{id:ContestEntryAPI}
...
And User redirect to the Search application 'ProcessContestEntry'
