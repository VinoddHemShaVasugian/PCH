...
public class LoginPage extends PageObject {
	...
	/**
	 * Login to the Search Joomla admin
	 * 
	 * @param username
	 * @param password
	 */
	...
	/**
	 * Login to the Sams Joomla admin
	 * 
	 * @param username
	 * @param password
	 */
	public void loginSamsAdmin() {
		...
		getDriver().get(configInstance.getEnvironmentProperty("SamsUrl"));
		this.enterUsername(configInstance.getEnvironmentProperty("SamsUserName"));
		this.enterPassword(configInstance.getEnvironmentProperty("SamsPassword"));
		this.submitLoginForm();
		waitForRenderedElementsToBePresent(joomlaIcon);
		clickOn(element(joomlaIcon));
	}
