...
public class DateUtil {
	...
	private static DateUtil dataUtilInstance = null;
	 ...
	 *
	 * @param dateStringfromRequest
	 *            the date stringfrom request
	...
	/**
	 * Returns the Month with the given offset value Based on the given offset
	 * value, the Month will be added or subtracted.
	 * 
	 * @return
	 * @author mperumal
	 */
	...
	/**
	 * Returns the Year with the given offset value Based on the given offset value,
	 * the year will be added or subtracted.
	 * 
	 * @return
	 * @author mperumal
	 */
	...
	/**
	 * Returns the Date with the given offset value Based on the given offset value,
	 * the Date will be added or subtracted.
	 * 
	 * 
	 * @return
	 * @author mperumal
