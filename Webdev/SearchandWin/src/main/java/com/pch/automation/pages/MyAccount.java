...
public class MyAccount extends PageObject {
	...
	public int verifyTokenTransactionsDetails(String description, String tokenAmount, int numberOfOccurrences) {
		...
		System.out.println("Count of Token Transaction details: " + descList.size());
		for (int count = 1; count <= descList.size(); count = count + 1) {
			System.out.println("Tracking details of -" + count + "- Token Transaction");
			...
			if (descList.get(count - 1).getText().contains(description)) {
				...
				System.out.println("No. of times token transaction message found: " + numberOfTimesTokenTransactionMsg);
	...
	public boolean verifyTokenTransactionsDescription(String description, int no_of_occurrences) {
		...
		System.out.println("Count of Token Transaction details: " + desc_list.size());
