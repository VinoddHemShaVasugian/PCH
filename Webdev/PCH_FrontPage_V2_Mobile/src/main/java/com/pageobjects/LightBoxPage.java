...
public class LightBoxPage extends BaseClass {
	...
	private final By gs_overlay_close_icon = By.cssSelector("button.gs-overlay__close-button ");
	private final By gs_overlay_search_box = By.cssSelector("div#modalSearchBoxWrapper input#searchField2");
	private final By gs_overlay_submit_search = By
			.cssSelector("div#modalSearchBoxWrapper div.search__bar-wrapper__submit");
	...
	/**
	 * This method is explicitly to close Bronze level up. This will work only
	 * for Bronze Level.
	 */
	...
	/**
	 * Click on GS Overlay close icon
	 */
	public void close_gs_overlay() {
		button(gs_overlay_close_icon, 5);
	}

	/**
	 * Search a term on GS overlay box
	 */
	public void search_on_gs_overlay(String keyword) {
		textbox(gs_overlay_search_box, "enter", keyword, 30);
		button(gs_overlay_submit_search, 30);
	}
}