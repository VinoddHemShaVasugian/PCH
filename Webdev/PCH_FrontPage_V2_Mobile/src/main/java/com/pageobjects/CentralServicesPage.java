...
public class CentralServicesPage extends BaseClass {

	private static CentralServicesPage cs_instance = new CentralServicesPage();

	private CentralServicesPage() {
	}
	 ...
	 * @return cs_instance
	 */
	public static CentralServicesPage getInstance() {
		return cs_instance;
	}
	 ...
	 */
	public String[] create_gold_user() {
		...
		log.info("Newly Registered Gold reg user Email URL is :: "
				+ (xmlReader(ENVIRONMENT, "BaseURL") + "/?email=" + user_email + "&e=" + get_gmt_from_respose()));
		user_details[0] = user_email;
		user_details[1] = xmlReader(ENVIRONMENT, "BaseURL") + "?email=" + user_email + "&e=" + get_gmt_from_respose();
		return user_details;
	 ...
	 */
	public String[] create_silver_user() {
		String user_details[] = new String[2];
		String user_email = "PCH" + randomString(5, 6) + Date() + "@pchmail.com";
		...
		log.info("Newly Registered Silver reg user Email URL is :: "
				+ (xmlReader(ENVIRONMENT, "BaseURL") + "/?email=" + user_email + "&e=" + get_gmt_from_respose()));
		user_details[0] = user_email;
		user_details[1] = xmlReader(ENVIRONMENT, "BaseURL") + "/?e=" + get_gmt_from_respose() + "&email=" + user_email;
		return user_details;
	}
	...
	public String[] create_mini_reg_user() {
		String user_details[] = new String[2];
		String user_email = "PCH" + randomString(5, 6) + Date() + "@pchmail.com";
		...
		log.info("Newly Registered Mini reg user Email URL is :: "
				+ (xmlReader(ENVIRONMENT, "BaseURL") + "/?src1=swemail&src2=13S2505&mailid=pch13S2505&e="
						+ get_gmt_from_respose() + "&email=" + user_email));
		user_details[0] = user_email;
	...
	public String[] create_social_user() {
		String user_details[] = new String[2];
		...
		log.info("Newly Registered Social reg user Email URL is :: "
				+ (xmlReader(ENVIRONMENT, "BaseURL") + "/?src1=swemail&src2=13S2505&mailid=pch13S2505&e="
						+ get_gmt_from_respose() + "&email=" + user_email));
		user_details[0] = user_email;
		user_details[1] = xmlReader(ENVIRONMENT, "BaseURL") + "/?src1=swemail&src2=13S2505&mailid=pch13S2505&e="
	...
	public String get_gmt_from_respose() {
		String Response;
		int Pos;
