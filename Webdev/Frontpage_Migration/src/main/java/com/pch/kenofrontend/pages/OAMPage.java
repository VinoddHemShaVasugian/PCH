...
public class OAMPage extends PageObject {	
	...
	CreateUserWithoutPassword cuwop;
	...
	{		
		...
		System.out.println(" this is  email " + CreateUserWithoutPassword.email);
		WaitHelper.waitForElementToBeClickable(getDriver(), EmailTextBox,30);
		WaitHelper.forceWait(7000);
		element(EmailTextBox).typeAndEnter(CreateUserWithoutPassword.email);
		}
	...
	{		
		...
		System.out.println(" this is  email " + regPage.rand_Email);
		WaitHelper.waitForElementToBeClickable(getDriver(), EmailTextBox,30);
		WaitHelper.forceWait(7000);
		element(EmailTextBox).typeAndEnter(regPage.rand_Email);
		}
