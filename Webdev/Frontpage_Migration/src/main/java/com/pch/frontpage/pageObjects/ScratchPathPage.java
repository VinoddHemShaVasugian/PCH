...
public class ScratchPathPage extends BaseClass {
	...
	private final By scratch_path_total_game_count = By.cssSelector("span.pathgame__game-progress-total");
	 ...
	 * @return
	 */
	public String get_scratch_path_total_game_count() {
		return getText(scratch_path_total_game_count, 60);
	}
	 ...
	 * @throws Exception
	 */
	public void wait_for_scratchpath_ads_to_complete() throws Exception {
		try {
			waitForElementNotVisible(ad_video_player, 150);
		} catch (Exception e) {
