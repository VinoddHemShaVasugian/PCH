...
public class AnniversaryTokenAwardTests extends BaseTest {
	...
	@Test(description="Anniversary tokens should not be awarded before anniversary date")
	...
	@Test(description="Anniversary tokens should be awarded on anniversary date")
	...
	@Test(description="Anniversary tokens should be awarded if login is on one day after anniversary date")
	...
	@Test(description="Anniversary tokens should be awarded if login is within seven days of anniversary date")
	...
	@Test(description="Anniversary tokens should not be awarded if login is after seven days of anniversary date")
