...
public class EcParameterThroughEmailTests extends BaseTest {
	...
	public void testEntriesComfirmed(){
		...
		Assert.assertTrue(latestActivity.contentEquals("Your entry has been confirmed!"));
		...
		Assert.assertTrue(latestActivity.contentEquals("Your entries have been confirmed!"));
