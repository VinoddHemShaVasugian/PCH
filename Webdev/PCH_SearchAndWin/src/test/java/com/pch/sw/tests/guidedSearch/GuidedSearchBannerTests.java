...
public class GuidedSearchBannerTests extends BaseTest {
	...
	@Test(groups={GroupNames.Desktop}, description="Un-recognized users GS Banner validation tests - 29930.")
	public void gsBanner_UnrecUser(){
		...
		*/
		...
		CustomLogger.log("Validating banner for for GS - SWGSVamsiL2_Enabled");
		...
		homePage.loadGuidedSearch("SWGS_L2_InvalidOpenx");
	...
	@Test(groups={GroupNames.Desktop}, description="recognized users GS Banner validation tests - 29930.")
