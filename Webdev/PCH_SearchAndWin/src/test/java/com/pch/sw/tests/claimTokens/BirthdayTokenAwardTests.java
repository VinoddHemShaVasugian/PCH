...
public class BirthdayTokenAwardTests extends BaseTest {
	...
	@Test(/*dependsOnMethods="testBirthDayTokenConfiguration",*/description="Birthday tokens should not be awarded before birthday but other tokens should be awarded, e.g. tomorrow", priority=1)
	...
	@Test(/*dependsOnMethods="testBirthDayTokenConfiguration",*/description="Birthday tokens should be awarded on Birthday along with other tokens")
	...
	@Test(/*dependsOnMethods="testBirthDayTokenConfiguration",*/description="Birthday tokens should be awarded if Birthday was yesterday (along with other tokens)")
	...
	@Test(/*dependsOnMethods="testBirthDayTokenConfiguration",*/ description="Birthday tokens should be awarded if Birthday was within 7 days (along with other tokens)")
	...
	@Test(/*dependsOnMethods="testBirthDayTokenConfiguration",*/ description="Birthday tokens should not be awarded if Birthday was before 7+ days (along with other tokens)")
