...
public class RemoveWelcomeMessage extends BaseTest {
	...
	@Test(groups={GroupNames.Mobile,GroupNames.Desktop},testName="RemoveWelcomeMessageTheFirstLogin",description = "TestID='16236'-Verifying welcome message in Search after FirstLogin in pch.com")
	public void removeWelcomeMessageTheFirstLogin(){
		...
		//validating welcome light box - we should not see any welcome light box.
		webBasePage.load();
