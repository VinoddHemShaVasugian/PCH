...
public class GuidedSearchNFSPTests extends BaseTest {
	...
	@Test(groups = {
			GroupNames.Mobile }, testName = "GuidedSearch-NFSP_Mobile-TestID-30267", description = "verify default nfsp for guest and registered user")
	...
	@Test(groups = {
			GroupNames.Mobile }, testName = "GuidedSearch-NFSP_Mobile-TestID-30267", description = "Navigate to any created guided search and validate nfsp for guest and registered user")
	...
	@Test(groups = {
			GroupNames.Mobile }, testName = "GuidedSearch-NFSP_Mobile-TestID-30267", description = "Update nfsp field of any guided search and verify nfsp for guest and registered user")
