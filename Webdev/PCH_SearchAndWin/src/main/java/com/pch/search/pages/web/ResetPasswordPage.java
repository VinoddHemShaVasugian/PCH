...
public class ResetPasswordPage extends Action {
	...
	private boolean mailDisplayed(String mailID){
		return driver.findElement(By.xpath(".//*[@id='FolderTree']/ul/li/div/span[3][contains(text(), '"+mailID+"')]")).isDisplayed();
	}
	
	private HtmlElement inbox(){
		return driver.findElement(By.xpath(".//span[@class='rtIn'][contains(text(), 'Inbox')]"));
	}
	...
	private int getunreadMails(){
		return driver.getCountOfElementsWithXPath(".//*[@id='ucMailbox_msgGrid_ctl00']/tbody/tr/td[2]/nobr");
	}
	
	private boolean stausOfFirstMail(){
		return driver.getCountOfElementsWithXPath(".//*[@id='ucMailbox_msgGrid_ctl00']/tbody/tr[1]/td[2]/nobr")>0;
	}
	
	public HtmlElement helpIsOnTheWay(){
		return driver.findElement(By.id("pwdr_msg"));
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public boolean openMailAndValidateCreatePassword(Date d){
		...
		String expectedSender ="Publishers Clearing House";
		String expectedSubject="Forgot Your Password?";
		...
		String trimDate = dateString.substring(0, 12);
		...
		inbox().click();
		homePage.waitFor(3);
		driver.switchtoFrame("iframe_632e17a2-9504-4b5b-8f9b-77a9cd4e23c1");
		...
		if(unreadMsgCount > 0){
			for(int i = 1; i<=unreadMsgCount; i++){
				...
				if(actualSender.equalsIgnoreCase(expectedSender)&&actualSubject.equalsIgnoreCase(expectedSubject)&&mailDate.contains(trimDate)){
					driver.findElement(By.xpath(".//*[@id='ucMailbox_msgGrid_ctl00']/tbody/tr["+i+"]")).click();
					break;
				}
		...
		/*String messageBody = driver.findElement(By.id("MessageBody")).getText();*/
	...
	public boolean resetPasswordValidateCreatePswdLinkTwice(String email){
		...
		HtmlElement createPswd = driver.findElement(By.xpath("html/body/span/table/tbody/tr/td/a/img"));
		createPswd.click();
		homePage.waitFor(3);
		...
		HtmlElement resetPwsdInput = driver.findElement(By.id("PW"));
		HtmlElement confirmResetPswdInput = driver.findElement(By.id("CPW"));
		HtmlElement submitbtn = driver.findElement(By.id("sub_btn"));
		...
		if(driver.getCountOfElementsWithXPath(".//*[@id='message_area']")>0){
			...
			CustomLogger.log("Navigating to Accounts page and validating email id");
			driver.findElement(By.xpath("//a[contains(text(),'My Account')]")).click();
			//Assert.assertTrue(driver.findElement(By.id("EM")).getAttribute("value").equalsIgnoreCase(email), "Email id mis-matched..");
			Assert.assertTrue(driver.findElement(By.xpath(".//*[@class='address ssoemail']")).getText().equalsIgnoreCase(email), "Email id mis-matched..");
			driver.close();
			...
			Assert.assertTrue(driver.getTitle().contains("Error/Reset"), "Hope you are not on the required page..");
			...
			driver.findElement(By.xpath("html/body/div[3]/p/a[contains(text(), 'CONTINUE')]")).click();
	...
	private HtmlElement enterEmailAddress(){
		return driver.findElement(By.id("EM"));
	}
	...
	public void verifyPasswordExpiredRefound(String mailIDforForgetPwsd){
		String regFound = "http://centralservices."+Environment.getEnvironment()+".pch.com/RFApi_v8/Svc/testpage.aspx#";
		driver.waitForBrowserToLoadCompletely();
		...
		Assert.assertTrue(pswdAssistancePageHeader().getText().contains("We're Sorry!"), "We are not seeing a valid message, we arseeing : "+pswdAssistancePageHeader().getText());
	...
	public void verifyWithInvalidIDs(){
		...
		submitbtn.click();
		homePage.waitFor(2);
		if(driver.getCountOfElementsWithXPath(".//*[@class='sso-outer-shell']")>0){
			String errorHeaderContent = driver.findElement(By.xpath(".//*[@class='sso-outer-shell']/div[contains(@class,'header')]")).getText();
			String errorMainContent = driver.findElement(By.xpath(".//*[@class='sso-outer-shell']/div[contains(@class,'inner-shell')]/div")).getText();
			CustomLogger.log("Header : "+errorHeaderContent);
			CustomLogger.log("Header : "+errorMainContent);
			Assert.assertTrue(errorHeaderContent.contains("PLEASE FILL IN THE FOLLOWING FIELDS:"), "We are seeing some other alert : "+errorHeaderContent);
		...
		if(driver.getCountOfElementsWithXPath(".//*[@class='sso-outer-shell']")>0){
			...
			CustomLogger.log("Header : "+errorHeaderContent);
			CustomLogger.log("Header : "+errorMainContent);
			Assert.assertTrue(errorHeaderContent.contains("PLEASE CORRECT BELOW AND RE-SUBMIT."), "We are seeing some other alert : "+errorHeaderContent);
