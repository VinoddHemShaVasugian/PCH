...
public class Environment {
	...
	public static String setPCHUSERcontent() {
		return getParam("PCHUSERcontent");
	}
	...
	public static void refreshPropertyMap(ITestContext context) {
		...
		// System.out.println("Removed entry for
		// "+Thread.currentThread().getId()+
		// " from propertyNThreadMap requested after method of class "+
		// context.getAttribute("className"));
	}
