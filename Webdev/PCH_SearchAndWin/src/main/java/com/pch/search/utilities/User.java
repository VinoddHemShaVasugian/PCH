...
public class User {
	...
	public List<String> getUserDetaislToVerifyMiniorSilverPCHUSER(String userType){
		...
		if(title.equalsIgnoreCase("Mr.")){
			gender = "m";
		}else if (title.contains("Mrs")||title.contains("Ms")) {
			gender = "f";
		}
		
		userDetails.add("PCHUSER.title = \""+title); userDetails.add("PCHUSER.firstName = \""+firstname);
		userDetails.add("PCHUSER.lastName = \""+lastname); userDetails.add("PCHUSER.fullname = \""+fullName);
		userDetails.add("PCHUSER.gender = \""+gender+"\""); userDetails.add("@pch-user-privacy-protected.com");
		if(user.contains("mini")){
			userDetails.add("PCHUSER.registrations = \"BLINGO\";"); userDetails.add("PCHUSER.reglist = [\"BLINGO\"];");
		}else if (user.contains("silver")) {
			userDetails.add("PCHUSER.registrations = \"BLINGO,PCHCOM\";"); userDetails.add("PCHUSER.reglist = [\"BLINGO\",\"PCHCOM\"];");
		}
