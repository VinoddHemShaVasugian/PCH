...
public class ExcelUtil {
	...
	public void insertLogo() throws IOException, RowsExceededException, WriteException{
		mergeCell(0, 0, 5, 0);
		String swLogoPath=System.getProperty("user.dir")+ "\\BrowserDriver\\S&WLogo.PNG";
		WritableImage image = new WritableImage(0, 0, 4, 4, new File(swLogoPath));
