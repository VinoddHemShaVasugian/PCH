...
public class VipTests extends BaseClass {
	...
	@testId(test_id = "34758")
	@testCaseName(test_case_name = "B-55373 [VIP] [Search] Integrate with VIP Assets - Including Lightbox [DT]")
	@Test(priority = 1, description = "Verify the VIP call trigger order in presence of lightbox", groups = { "DESKTOP",
			"TABLET" }, testName = "34758:B-55373 [VIP] [Search] Integrate with VIP Assets - Including Lightbox [DT]")
