...
public class MinireguserTests extends BaseClass {
	...
	public void verify_claim_button_on_all_pages_for_mini_reg_user() throws Exception {
		test_Method_details(1, "Verify the Claim button on all pages for the Mini Reg user");
	...
	@Test(priority = 2, groups = { "DESKTOP",
			"TABLET" }, description = "Verify the Registration form field validation for Social user", testName = "RT-04210:Mini Reg user test scenario [D/T]")
	...
	@Test(priority = 3, groups = { "DESKTOP",
			"TABLET" }, description = "Verify the PCH Properties on Uni Nav bar for Mini Reg user", testName = "RT-04210:Mini Reg user test scenario [D/T]")
	public void verify_uni_nav_bar() throws Exception {
		test_Method_details(1, "Verify the PCH Properties on Uni Nav bar for Mini Reg user");
		// Step 1
		test_step_details(1, "Create new Mini Reg user and go to FP");
