...
/*		admin_instance.goToArticlePage();
		...
		// Disable the openx and enable SAMS banner
		admin_instance.goToArticlePage();
		admin_instance.search_for_article("config-SearchBox");
		admin_instance.enter_input_field_element_by_key_name("samsBanner", "true");
		admin_instance.enter_input_field_element_by_key_name("edl_samsBanner", "true");
		admin_instance.enter_input_field_element_by_key_name("horoscope_edl_samsBanner", "true");
		admin_instance.enter_input_field_element_by_key_name("openx", "false");
		admin_instance.enter_input_field_element_by_key_name("edl_openx", "false");
		admin_instance.save_and_close_article();
		admin_instance.goToArticlePage();
		admin_instance.search_for_article("open x");
