...
public class LightBoxPage extends BaseClass {
	...
	private final By evergage_close_button = By.cssSelector("a.closeButton");
	...
	/**
	 * To close Evergage light box, I am here to make you happy lb
	 */
	public void close_evergage_light_box(){
		button(evergage_close_button, 10);
	}
