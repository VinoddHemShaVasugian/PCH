...
public class HomePage extends BaseClass {
	...
	private final By collapse_search_box = By.id("searchField0");
	private final By latest_activity_message = By.cssSelector("p.uninav__message-center__source");
	private final By latest_activity_amount = By.cssSelector("p.uninav__message-center__earnings");
	private final By latest_entry_activity_message = By.cssSelector("div.uninav__message-center__message-display>p");
	private final By Register = By.linkText("Register");
	private final By sign_in = By.linkText("Sign In");
	private final By complete_registration = By.cssSelector("div.uninav__continue-registration a");
	...
	private final By edl_header_menu = By
			.xpath("//div[@id='header']//li[@class='menu__item   menu__item--everydaylife']/a");
	...
	/**
	 * 
	 * click on the EveryDayLife menu option
	 */
	public void click_edl_headermenu() {
		button(edl_header_menu, 10);
	}
	...
	public void click_first_video_link() {
		...
		button(get_webelements_list(first_video_link_from_top_stories).get(0), 15);
	}
	...
	/**
	 * Return the Sub_catagory pages name in list. It includes the More menu
	 * also.
	 * 
	 * @return
	 */
	...
	public void click_weather_our_pick() {
		button(our_pick_weather_link, 5);
	}
	...
	/**
	 * Verify the visibility of the Play icon on the first OurPick tile to
	 * validate it as a Video story type
	 */
