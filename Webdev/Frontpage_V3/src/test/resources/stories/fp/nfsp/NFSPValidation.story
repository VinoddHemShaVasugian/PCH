...
GivenStories: stories/fp/jm/FpAdmin.story#{id:Config_Infospace},
stories/fp/jm/FpAdmin.story#{id:Config_RiskManagement}
...
Then Verify NFSP source and segment as per admin config 'nfspAccessIds','portv2'

Scenario: Verify the algo NFSP value for UnRecognised User 
Meta: 
@TestingType Sanity
Given Go to Frontpage site
When Perform consecutive searches 'algo_only_searches_unrecognized'
...
When Do a search and Verify SERP page
Then Verify algo NFSP source and segment as per admin config 'nfspAccessIds','mx_d','mx_t','mx_m'
And User redirect to the Frontpage application 'nfsp=fpcontrol'
...
When Do a search and Verify SERP page
Then Verify NFSP source and segment as per admin config 'nfspAccessIds','portv2'
And User redirect to the current URL 'nfsp=fpcontrol'
And Verify NFSP source and segment as per admin config 'nfspAccessIds','fpcontrol'