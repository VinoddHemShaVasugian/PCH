...
Scenario: Verify the complete registration functionality for Mini reg user type
...
Scenario: Do a search and verify the complete registration functionality for Mini reg user type
Given Register a mini registered user through RF and login to the site
When Verify complete registration button on the uninav
