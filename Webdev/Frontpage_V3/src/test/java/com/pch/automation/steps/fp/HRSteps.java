...
public class HRSteps extends ScenarioSteps {
	...
	public void searchForMultipleTimes(String duplicateSearchRate) {
		...
		serpPage.consecutiveSearches(Integer.parseInt(FpAdminSteps.getArticleDetails().get(duplicateSearchRate)),
				keyTerm);
	}
	...
	public void closeFancyLb() {
		lbPage.closeHRFancyLightbox();
	}
}
