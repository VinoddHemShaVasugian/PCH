...
public class FpAdminSteps extends ScenarioSteps {
	...
	@Step
	public void storeMenuURLS(String menuName, String url) {
		articleDetails.put(menuName, url);
	}
}
