...
public class ProfileBuilderStepDefinitions {
	...
	public void verifyQuestionCountInDb() {
		...
		Assert.assertEquals("Answered profile questions in DB ", profileSectionPage.getNumberOfQuestionsAnswered(),
				RedisClient.getResultAsMap(key).size());
	...
	public void navigateToProfilBuilder() {
		profilePage.navigateToProfileBuilder();
	}
}
