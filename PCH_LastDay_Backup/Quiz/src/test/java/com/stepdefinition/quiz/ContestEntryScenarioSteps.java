...
import com.steps.quiz.ContestEntrySteps;

import net.thucydides.core.annotations.Steps;

public class ContestEntryScenarioSteps {
	...
	public void verifyContestEntriesForOrganicUser(String airtcleName, String labelName) {
		...
		String expectedContestEntry = AdminSteps.getArticleDetails().get(airtcleName+labelName).trim();
		boolean ck = false;
