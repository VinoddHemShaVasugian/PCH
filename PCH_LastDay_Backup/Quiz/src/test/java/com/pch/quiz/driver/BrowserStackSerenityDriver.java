...
/**
 * Driver and environment specific config file.
 * 
 * @author vsankar
 *
 */
...
public class BrowserStackSerenityDriver implements DriverSource {
	...
	public WebDriver newDriver() {
		...
		try {
			...
			capabilities.setCapability("project", "Quiz");
