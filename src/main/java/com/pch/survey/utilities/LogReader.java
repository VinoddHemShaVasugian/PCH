...
//	private static String offerLogsUrl = "";
//	private static String surveyLogsUrl = "";
...
//			logUrl = offerLogsUrl + "ListenersLogger-2023-08-25.log";
	...
	public static List<String> scrubEventList(List<String> actualEventList, List<String> eventsToIgnore) {
		...
		for (String event : actualEventList) {
			...
			for(String ignore : eventsToIgnore){
				if (event.contains(ignore)){
					ignoreEvent=true;	
					break;
				}
			}
