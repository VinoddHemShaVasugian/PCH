...
@CucumberOptions(features = { "classpath:features/offers/events/sqs/sqs_sanity.feature" }, plugin = { "pretty", "html:target/cucumber-reports/Cucumber.html",
		"com.epam.reportportal.cucumber.ScenarioReporter" }, glue = {
				"com.pch" }, stepNotifications = false, tags = ("@Desktop"))

public class SQSRunnerTest {
